...
data = np.loadtxt("txtFiles/1400V/afterpulseQ_vs_date_Ch1.txt", unpack=True, delimiter=",")
...
plt.errorbar(Exposure,avgq, yerr=err1, marker='.',capsize=2, label="title", ls = 'none')
