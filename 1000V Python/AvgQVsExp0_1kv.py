...
data = np.loadtxt("txtFiles/1000V/afterpulseQ_vs_date_Ch0_1kV.txt", unpack=True, delimiter=",")
...
plt.ylim(7,8)
plt.title('Average afterpulse charge vs Exposure PMT Ch0 @ 1kV')

plt.savefig('SummaryPlots/1000V/AvgQVsExp0_1kV.pdf')
plt.show()